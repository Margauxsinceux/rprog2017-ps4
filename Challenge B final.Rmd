---
title: "Challenge B"
author: "Maxime GRANDMAITRE Gaudéric THIETART Margaux SINCEUX"
date: "06/12/2017"
output: pdf_document
---
...
```{r, echo = TRUE}
library(data.table)
mat <- fread("~/master 1 S1/r/challenge B/sirene_201710_L_M/sirc-17804_9075_14209_201710_L_M_20171101_030132835.csv",sep =";", dec = ".", header = T, select = c("SIREN", "LIBTEFEN", "DATEMAJ"))
head (mat)
```
...
format(step_3$DATE, format="%Y %m %d")
